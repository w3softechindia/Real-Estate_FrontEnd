...
export const salesFunnelOptions: Partial<ChartOptions> = {
  chart: {
    type: 'area',
    height: 165,
    sparkline: {
...
export const agentOptions: Partial<ChartOptions> = {
  series: [
    {
      name: 'Property Sales',
      type: 'bar',
...
export const goalsOptions: Partial<ChartOptions> = {
  chart: {
    height: 320,
    type: 'radialBar',
  },
...
export const joinAgent: JoinType[] = [
  {
    name: 'Ryan G. Harris',
